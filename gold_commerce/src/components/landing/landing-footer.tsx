...
import { WALLET_REGISTER_URL, WALLET_SIGN_IN_URL } from "@/lib/site-links";
  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        ...
        // Both live in the wallet app on its own origin — see site-links.ts.
        { href: WALLET_SIGN_IN_URL, label: t.nav.login, external: true },
        { href: WALLET_REGISTER_URL, label: t.nav.register, external: true },
      ],
    },
  ];
