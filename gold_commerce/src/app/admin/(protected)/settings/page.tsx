...
import { FileText, Hash, Mail, MapPin, PercentCircle, Phone, ScrollText, Users, Weight } from "lucide-react";
import { siteSettingsSchema, type SiteSettingsInput } from "@/lib/validations/settings";
import { aboutStatsSchema, type AboutStatsInput } from "@/lib/validations/stats";
  ...
  return (
    <Card className="max-w-md">
      <CardHeader>
        ...
        <CardDescription>Facebook, Instagram, LinkedIn, and YouTube — shown in this order in the footer. Leave a field blank to hide that icon there.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
...
function AboutStatsCard() {
  ...
  function onSubmit(values: AboutStatsInput) {
    updateStats.mutate(values, {
      ...
      onError: (error) => toast.error(error instanceof ApiError ? error.message : "Failed to update stats"),
    });
  }
  ...
  return (
    <Card className="max-w-md">
      <CardHeader>
        ...
        <CardDescription>Customers, vaulted metal, and insured holdings — shown in this order in the public site&apos;s About section. Each starts at 0 until set here.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
...
export default function AdminSettingsPage() {
  return (
    <div className="space-y-6">
      <PageHeader title="Site settings" description="Business details, footer links, and About section stats shown on the public site." />
