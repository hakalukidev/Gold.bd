...
/** Light/dark toggle for the dashboard chrome — next-themes swaps the `dark`
 * class on <html> (see providers.tsx), which globals.css's full :root/.dark
 * token pair then drives every shadcn component through automatically.
 *
