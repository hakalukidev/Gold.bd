 ...
 * or vori, the unit Bangladeshi gold buyers actually think in. */
const PRICE_UNITS = [
        ...
        <div className="space-y-4">
          <Card>
            <CardContent className="space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <span className="text-sm font-medium text-muted-foreground">{METAL_LABEL[metal]} price</span>
                <PillToggle
              ...
              <div className="flex flex-wrap items-end gap-x-3 gap-y-1">
                ...
                <span className="pb-1 text-sm text-muted-foreground">
                  per {unit.label.toLowerCase()} · {METAL_LABEL[metal]}
                </span>
                <span className="pb-1">
